...
const InitialLoader = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-25 right-20 text-black text-9xl  z-1000">{'{'}</div>
      <div className="absolute top-68 right-42 text-black text-9xl  z-1000">{'}'}</div>

      {/* Main content */}
      <div className="flex-1 flex flex-col justify-center pl-20 z-1000 relative">
      ...
      <div className="w-full px-20 pb-12 z-1000 relative flex items-center justify-end">
